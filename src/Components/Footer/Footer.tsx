...
const Footer = () => {
  return (
    <footer className="pb-10">
      <section className="container w-full h-115 bg-[#0B0B0B] rounded-4xl px-27.25 py-20 mx-auto ">
        <div className="text-center">
          ...
          <nav className="flex gap-10 mt-6 border-t-2 border-b-2 border-dashed border-text-primary py-6 text-light-gray ">
            <ul className="hidden lg:flex items-center gap-8 text-light-gray font-medium mx-auto">
              {links.map((link) => (
